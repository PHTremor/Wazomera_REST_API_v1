...
// BookQueries struct for queries for the Book model.
type BookQueries struct {
	*sqlx.DB
}

// GetBooks method -gets all books.
...
// GetBook method -gets one book by a given ID.
...
// CreateBook method -creats a book by given Book object.
...
// UpdateBook method - updates a book by the given Book object.
...
// DeleteBook method - deletes a book by a given ID.
